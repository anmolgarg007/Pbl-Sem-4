...
print("\n==============Developed By Anmol Garg and Prakash Chand Thakuri================================")
...
#### Strings Analysis Extracting Atrings From File ####
    ...
    print('\n\n ==============[-] Oops!, Program Halted=====================')
    print("\n====================The program is halted due to the following reasons:==============================")
    print("\n1.The file is corrupted..\n2. The file is not an EXE file \n3. The path is not in a directory \n4.Check requirement file of the program")
